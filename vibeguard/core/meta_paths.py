...
class MetaPaths:
    ...
    @property
    def vibeguard_dir(self) -> Path:
        return self.root / ".vibeguard"
    ...
    def watch_state_path(self) -> Path:
        return self.vibeguard_dir / "watch_state.json"

    @property
    def watch_log_path(self) -> Path:
        return self.vibeguard_dir / "watch.log"
    ...
    def ensure_vibeguard_dir(self) -> None:
        self.vibeguard_dir.mkdir(parents=True, exist_ok=True)
